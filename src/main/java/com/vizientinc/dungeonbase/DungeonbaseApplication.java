...
public class DungeonbaseApplication implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		if(start == null){
			...
			caveMouth = locationRepository.save(caveMouth);
			...
			goblinBlind = locationRepository.save(goblinBlind);
			...
			kennel = locationRepository.save(kennel);
			...
			steepPassage = locationRepository.save(steepPassage);
			...
			overpass = locationRepository.save(overpass);
			...
			goblinDen = locationRepository.save(goblinDen);
			...
			twinPools = locationRepository.save(twinPools);
			...
			klargsCave = locationRepository.save(klargsCave);
